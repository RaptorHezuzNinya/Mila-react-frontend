...
export const formFieldsContactDetails = [
  'firstName',
  'lastName',
  'companyRole',
  'companyName',
...
export const dataTopMenu = currentRoute => [
  {
    ...
    iconComp: (
      <NewContactIcon
        className={
          currentRoute === '/sortcontact' ? 'icon active-icon' : 'icon'
        }
      />
    ),
    title: 'New Contacts',
  },
  {
    ...
    iconComp: (
      <NetworkIcon
        className={currentRoute === '/mynetwork' ? 'icon active-icon' : 'icon'}
      />
    ),
    title: 'My Network',
  },
  {
    ...
    iconComp: (
      <ListSettingsIcon
        className={
          currentRoute === '/settings/list' ? 'icon active-icon' : 'icon'
        }
      />
    ),
    title: 'List Settings',
...
export const formDataCreateNetworkListModal = (
  maxTitleCount,
  titleCount,
  maxDescCount,
  descCount
) => [
  {
    ...
    formHeader: (
      <div className="title-details">
        <p className="list-name">Your list title</p>
        <p>{maxTitleCount - titleCount} left</p>
      </div>
    ),
  ...
  },
  {
    ...
    formHeader: (
      <div className="desc-details">
        <p className="desc-name">Your list description(optional)</p>
        <p>{maxDescCount - descCount} left</p>
      </div>
    ),
